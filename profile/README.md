...
Supported aspect ratios listed on this page:
9:16
16:9
1:1
4:5
...
Voice styles listed on this page:
Voice Style
Description
nova
Energetic and bright (default)
alloy
...
Integrations
This page states that Mira connects to 800+ apps via Composio.
...
+ 800 more
Figma, Linear, Jira, HubSpot, Airtable…
...
TON Wallet
This page states that every Mira user gets a personal TON wallet created automatically.
Examples of supported requests:
What's my wallet balance?
Send 5 USDT to @username
Swap 2 TON to USDT
Show my recent transactions
⚠️ The wallet is currently described here as running on testnet. Funds have no real monetary value.
...
Private Mode
For sensitive conversations, this page states that Mira routes requests to Cocoon, described here as a confidential compute network.
The comparison shown on this page:
...
The page also states that requests in Private Mode are processed inside a Trusted Execution Environment (TEE).
Enable path shown on this page: Mira mini-app → Discover → Private Mode

Infrastructure
Skills
This page describes Skills as scheduled automations with no code required.
Examples:
...
MCP Integrations
This page states that Mira supports MCP integrations to connect APIs and services.
Model Flexibility
This page states that Mira can switch between:
Claude
GPT-4o
Qwen
Gemini
...
Agent-to-Agent
This page states that Mira supports chaining specialized agents for multi-step workflows.
...
Voice messages and music generation
Video generation and processing
500+ integrations via Composio
TON Wallet (testnet)
Personal & group memory
Private Mode
Skills & scheduling
TON Wallet mainnet
